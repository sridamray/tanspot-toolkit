...
namespace tanspot_toolkit\PageSettings;
...
class Page_Settings
{
    ...
    {
        Controls_Manager::add_tab(self::PANEL_TAB, __('New Tab', 'tanspot-toolkit'));
    }
    ...
    public function register_document_controls($document)
    {
        ...
        $document->start_controls_section(
            'new_section',
            [
                'label' => __('Settings', 'tanspot-toolkit'),
                'tab' => self::PANEL_TAB,
            ]
        );
        ...
        $document->add_control(
            ...
            [
                ...
                'default' => __('Title', 'tanspot-toolkit'),
            ]
        );
